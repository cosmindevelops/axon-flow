...
import type { 
  ...
  INavigatorInfo, 
  IWindowInfo 
} from '@axon/types/platform/browser';
...
import type { 
  ...
  IEnvironment, 
  PlatformType 
} from '@axon/types/platform/common';
...
const config = new ConfigBuilder()
  ...
  .withValidation(environmentConfigSchema)
  .build();
```
