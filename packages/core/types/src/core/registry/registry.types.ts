...
import type { AgentId, IAgentCapability, IAgentMetadata } from "../agent/agent.types.js";
...
/**
 * Agent query for registry operations
 */
...
/**
 * Query options for agent search
 */
export interface IAgentQueryOptions {
  /** Maximum number of results */
  readonly limit?: number;
