...
import { ValidationErrorCategory as ValidationError, ApplicationError, BaseAxonError } from "@axon/errors";
...
describe("MockDIContainer", () => {
  ...
  describe("Error Scenarios", () => {
    ...
    it("should handle resolve errors gracefully", () => {
      ...
      expect(resolveCall!.error).toBeInstanceOf(BaseAxonError);
    });
  });
});
...
describe("DependencyMockBuilder", () => {
  ...
  describe("Fluent Interface", () => {
    ...
    it("should build mock with implementation", () => {
      ...
      builder.withImplementation(mockImplementation).build();
    ...
    it("should build mock with factory function", () => {
      ...
      builder.withImplementation(factory).withLifecycle("transient").build();
    ...
    it("should apply lifecycle configuration", () => {
      ...
      builder.withImplementation(mockImplementation).withLifecycle("singleton").build();
    ...
    it("should apply additional options", () => {
      ...
      builder.withImplementation(mockImplementation).withOptions(options).build();
...
describe("TestContainerBuilder", () => {
  ...
  describe("Container Configuration", () => {
    ...
    it("should configure container name", () => {
      const container = builder.withName("CustomTestContainer").build();
    ...
    it("should configure call tracking", () => {
      const container = builder.withCallTracking(false).build();
    ...
    it("should configure strict mode", () => {
      const strictContainer = builder.withStrictMode(true).build();
    ...
    it("should chain configuration methods", () => {
      const result = builder.withName("ChainedContainer").withCallTracking(true).withStrictMode(false);
  ...
  describe("Mock Dependencies", () => {
    ...
    it("should support multiple mock dependencies", () => {
      ...
      const container = builder.mockDependencies(mockConfigs).build();
    ...
    it("should accumulate multiple mockDependencies calls", () => {
      const config1: IMockProviderConfig[] = [{ token: "Service1", implementation: new TestService("mock1") }];

      const config2: IMockProviderConfig[] = [{ token: "Service2", implementation: new TestService("mock2") }];

      const container = builder.mockDependencies(config1).mockDependencies(config2).build();
...
describe("TestFixture", () => {
  ...
  describe("Setup and Teardown", () => {
    ...
    it("should reset mocks during teardown", async () => {
      const config: ITestFixtureConfig = {
        providers: [{ token: "MockService", implementation: new TestService("mock") }],
      };
...
describe("DITestAssertions", () => {
  ...
  describe("Registration Assertions", () => {
    ...
    it("should fail assertion for unregistered service", () => {
      ...
      expect(() => assertions.toHaveRegistration(mockContainer, "NonExistent")).toThrow(
        "Expected container to have registration for token: NonExistent",
      );
    });
  });
  ...
  describe("Resolution Assertions", () => {
    ...
    it("should fail assertion for failed resolution", () => {
      ...
      expect(() => assertions.toResolve(mockContainer, "NonExistent")).toThrow(
        "Expected container to resolve token: NonExistent",
      );
    });
  ...
  describe("Error Assertions", () => {
    ...
    it("should fail assertion when resolution succeeds", () => {
      ...
      expect(() => assertions.toThrowOnResolve(mockContainer, "TestService")).toThrow(
        "Expected container to throw when resolving token: TestService",
      );
    });
    ...
    it("should assert specific error type", () => {
      ...
      expect(() => assertions.toThrowOnResolve(mockContainer, "FailingService", BaseAxonError)).not.toThrow();
    });
    ...
    it("should fail assertion for wrong error type", () => {
      ...
      expect(() => assertions.toThrowOnResolve(mockContainer, "FailingService", ValidationError)).toThrow(
        ValidationError,
      );
      expect(() => assertions.toThrowOnResolve(mockContainer, "FailingService", ValidationError)).toThrow(
        "Expected container to throw ValidationError",
      );
    });
  });
  ...
  describe("Circular Dependency Assertions", () => {
    it("should indicate circular dependency detection is not implemented", () => {
      expect(() => assertions.toDetectCircularDependency(mockContainer, ["ServiceA", "ServiceB"])).toThrow(
        ApplicationError,
      );
      expect(() => assertions.toDetectCircularDependency(mockContainer, ["ServiceA", "ServiceB"])).toThrow(
        "Circular dependency detection testing not yet implemented",
      );
    });
  });
});
  ...
  describe("createTestFixture", () => {
    it("should create test fixture with configuration", () => {
      const config: ITestFixtureConfig = {
        ...
        providers: [{ token: "TestService", implementation: new TestService("factory") }],
      };
