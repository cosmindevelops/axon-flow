...
describe('SingletonLifecycleManager', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should throw error when used after disposal', () => {
      ...
      expect(() => manager.getInstance(token, () => new TestService())).toThrow('singleton lifecycle manager has been disposed');
    });
  });
...
describe('TransientLifecycleManager', () => {
  ...
  describe('Advanced Pooling', () => {
    it('should throw error for advanced pooling configuration', () => {
      ...
      expect(() => advancedManager.getInstance(token, factory)).toThrow('Advanced object pooling requires async getInstance method');
...
describe('ScopedLifecycleManager', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should throw error without resolution context', () => {
      ...
      expect(() => manager.getInstance(token, factory)).toThrow('Scoped lifecycle requires resolution context with scopedInstances');
    });
  });
